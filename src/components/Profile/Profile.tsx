...
import { requestUserComments, requestUserPosts, actionProfile } from '../../store/actions/profile/profile';
import { getUserComments, getUserPosts } from '../../store/selectors/ind';
